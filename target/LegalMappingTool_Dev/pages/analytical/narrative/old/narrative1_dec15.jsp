...
<div id="content-menu-container">
   ...
   <div id="content-container">
      ...
      <div id="content-onecolumn">
            ...
            <h2>D. IDENTIFYING PRIORITIES</h2>


            <!-- Analytics -->
         <div id='dataaccuracyreminder'> 
            <p>Note: The accuracy of the analytics is contingent on "B.3 Rights Protection" 
            and "C.Obstacles to Enjoying Rights" of the Legal Mapping Tool being completed in full. </p>
         </div>
         ...
         <form action="AnalyticalToolController?action=narrative&country=<%=countryNameForMenu%>" method="POST">
            ...
            <h3>A.6 The Importance of Specific Rights in Your Operational Context</h3>
            <br>
            ...
            <h3 id="B">D.1 Areas for Law and Policy Reform</h3>
            ...
            <h3 id="D">D.2 Priority Areas for Complementary Programming</h3>
            ...
            <h3 id="C2">C.2 Obstacle Analysis</h3>
   
            <p class="mediumparagraph">
   
               1. Using the data from the above tables and your knowledge of your country's legal context, what are the main obstacles
               ...
               <br> <br> 2. For the obstacles you identified in question 1, please describe the underlying reasons as to why these obstacles
               exist. <br><br>
...
$(function () {
    ...
    //Configuration of the rights group obstacles detail chart. 
        ...
        var firstChartSubTitle = '(1="There Are No, or Minimal, Obstacles to Enjoying the Rights in the Rights Category",' + 
        ...
        $('#detail-poc-obstacles-rightgroups-chart').highcharts({
            ...
            xAxis: {
                type: 'category',
                title: {text: 'Rights Category',style: {fontSize:'16px',fontWeight:'bold'}},
         labels:{style: {fontSize:'13px'}}
            },
            yAxis: {
                max:3,
