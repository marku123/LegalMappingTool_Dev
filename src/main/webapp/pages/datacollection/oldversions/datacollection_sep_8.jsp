   ...
   <div id="content-container">
      ...
      <div id="content-onecolumn" >
         ...
         <form action="DataCollectionController?action=datacollection&country=<%=countryNameForMenu%>" method="POST">
            <h2>B. THE LEGAL PROTECTION FRAMEWORK</h2>
            ...
            <h3 id="A1">B.1 The Country's Constitution</h3>
               ...
               <p>
                 ...
                 <table class="constpersons">
                  ...
                  <br> <br>
                  <h3 id="A2">B.2 The Country's Legal System</h3>
               ...
               <br><br><br>  
               <p>                     
                    13. Additional comments on the formal legal system:
                     <br> <br> 
